...
class App {
  ...
  _LoadMap(position) {
    ...
    // create a map:
    // first argument is the id of the element that will render the map
  ...
  _showForm(mapE) {
    // mapE is a data generated by leaflet map on mouse click
    this.#mapEvent = mapE;
